...
<div data-role="page">
    ...
    <c:if test = "${empty obj.cf || obj.cf.ahks_sj == 1}">
    ...
    <c:if test = "${empty obj.cf || obj.cf.ahks_ws == 1}">
    <table border="1" class="hdptable">
        <tr width="100%" class="tr-bgcolor">
    ...
    <c:if test = "${empty obj.cf || obj.cf.ahks_point == 1}">
    <table border="1" class="hdptable">
        <tr width="100%"  class="tr-bgcolor">
            <th colspan="6">点数</th>
        </tr>
    ...
    <c:if test = "${empty obj.cf || obj.cf.ahks_lc == 1}">
    <table border="1" class="hdptable">
        <tr width="100%"  class="tr-bgcolor">
    ...
    <c:if test = "${empty obj.cf || obj.cf.ahks_sc == 1}">
    <table border="1" class="hdptable">
        <tr width="100%" class="tr-bgcolor">
		...
		<div data-role="footer" class="ui-footer-fixed" style="background-color: #F3F5F2;">
	 	<div data-role="navbar" data-iconpos="left">
	         ...
	         <!-- 	<li class="ui-btn-rect-lot-green"></li> -->
	         	<li class="ui-btn-rect-lot-red"><a href="${ctx}/ssc/gameResultSingle?gid=16" data-ajax="false" style="color:green" data-icon="eye">近期开奖结果</a></li>
	     	</ul>
		</div>
	</div>
 </div>
    <form id="tempForm" data-ajax="false" action="${ctx}/ssc/ahsb/order" method="get">
        <input type="hidden" name="bon" value="BIG_SB">
        <input type="hidden" name="gameId" value="AHKS">
...
<script type="text/javascript">
    ...
    function getRate(){
        ...
        $.getJSON("${ctx}/ssc/ahsb/rate/"+(isAll?"all":"v")+"/"+new Date().getTime(),function(o) {
        	if(o.c == 0){
