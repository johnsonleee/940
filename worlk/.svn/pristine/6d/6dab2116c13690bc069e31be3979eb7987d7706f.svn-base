 ...
 */
public class BasketballFullHandle extends DefaultHandler {

	private boolean isI18n;
	private String lng;
	private ConcurrentHashMap<String, String> i18nMap;

	public BasketballFullHandle(boolean isI18n, String lng, ConcurrentHashMap<String, String> i18nMap, Sport sport) {
		this.isI18n = isI18n;
			...
			if (!isI18n) {
				...
				try {
					...
					if (start != null && !start.equals("")) {
						match.setStart(SportBBCache.normalSDF.parse(start));
					}
				} catch (Exception e) {
					e.printStackTrace();
				}
