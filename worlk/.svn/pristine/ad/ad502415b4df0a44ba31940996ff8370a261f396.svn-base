...
<div data-role="page">
    <div data-role="header" data-position="fixed" data-tap-toggle="false">
        <a href="${ctx}/ssc/menu" data-ajax="false" data-role="none" class="ui-btn2 ui-shadow ui-corner-all ui-icon-home ui-btn-icon-notext"> </a>
        <div class="header-bg">
    ...
    <div data-role="content">
        <form action="${ctx}/ssc/bjsc/submit" data-ajax="false">
...
<script type="text/javascript">
    ...
    function goBack(){
        window.location.assign("${ctx}" + ref);
    }
    ...
    $(function(){
        ...
        $("#submitBtn").on("click", function (e) {
        	if(isMoney()){
        		...
        		showSubmit();        	
	            var jqxhr = $.post("${ctx}/ssc/bjsc/submit", $("form").serialize(), function (o) {
	                hideLoader();
	                if (o.success == 1) {
	                    showResultSucceed();
	                } else if (o.success == 0) {
