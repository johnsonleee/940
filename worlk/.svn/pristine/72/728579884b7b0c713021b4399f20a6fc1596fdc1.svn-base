...
public class GameXjssAction {
	private Log log = Logs.getLog(GameXjssAction.class);

	@At("/ssc/xjssmenu")
	@Ok("jsp:page.ssc.xjss.gameXjss")
	public Object xjssmenu() {
	...
	public View topage(@Param("pageName") String pageName, @Param("gameId") String gameId, @Param("betOn") String betOn, @Param("nav") String nav) {
		...
		return new ViewWrapper(new JspView("page.ssc.xjss." + pageName), dataMap);
	}
}
