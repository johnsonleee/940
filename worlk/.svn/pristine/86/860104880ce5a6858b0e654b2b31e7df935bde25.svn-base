...
<body>
<c:set var="title" value="${msg['label.sport.fb.basketball']}" />
<div data-role="page" id="choosePage">
    ...
    <div data-role="content" style="margin:5px 0;" data-css="games">
        ...
        <div class="bg_c_bb">        
	        <div class="div_w100 hi30 b_color_04bb">
	            <div class="bcontain_bb">
	                <div id="m_score" class="f_left01 fnt14b lh30"></div>
	                <div id="m_time" class="f_right01 fnt14b lh30"></div>
	            </div>
	        </div>
	        <div class="title_divbb"><!--按钮外框-->
	            <div class="bcontain02bb">
    ...
    <div data-role="popup" id="popupDialog" data-overlay-theme="a" data-theme="a" data-dismissible="false" class="pop_width" data-history="false">
        <div role="main" class="ui-content" style="border:#66C1BB 2px solid;">
            ...
            <div style="background-color: #c6ecbd; color: #000000; padding: 10px 10px 10px 10px; text-shadow:none !important; font-size:14px;">
    ...
    <div id="toMuPage" data-role="footer" class="ui-footer-fixed" style="background-color: #054700;">
        <div data-role="navbar" data-iconpos="left">
            <ul>
                <li>
                    <a href="${ctx}/sport/bb/order"  class="ui-btn-green-defult" id="t_mubet" data-ajax="false" style="height: 30px; line-height: 30px; font-size: 15px;" class="ui-btn">${msg['label.sport.fb.ggtz']}<span id="ic">0</span>&nbsp;${msg['label.sport.fb.gxx']}</a>
                </li>
            </ul>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("a[t]").on("click", function () {
            if ($(this).attr("t") != ss.getItem("t")) {
                ...
                if ($(this).attr("t") == 1) {
                    ss.removeItem("mu");
                    ss.setItem("mu", 0);
                    ss.removeItem("bb_muis");
                }
                window.location.href = "${ctx}/sport/bb";
            }
        });
        ...
        $("#t_mubet").on("click", function (e) {
            e.preventDefault();
            var items = JSON.parse(ss.getItem("bb_muis"));
            if (items.length > 1) {
        ...
        $("#t_order_btn").on("click", function () {
            ...
            $("#t_order_btn").button("disable");
            $.post("${ctx}/sport/bb/func/bet", param, function (o) {
                //o = JSON.parse(o);
                if(o.c == 0){
                    if(o.d.bst == 1){
        ...
        $("#g_list").on("click", "div[tid]", function () {
            ...
            if (ss.getItem("mu") == 0) {
                ...
                var m;
                var digits = 2;
                if (",2,3,4,11,12,".indexOf(item.pid) != -1) {
                    m = ss.getItem("m");
                    digits = 3;
                } else {
                    m = 4;
                ...
                var ci_url = "${ctx}/sport/bb/func/ci/" + tid + "/" + m + "/" + roll + "/0";
                ...
                var items = null;
                var isExist = false;
                if (ss.getItem("bb_muis") == null) {
                    items = new Array();
                } else {
                    items = JSON.parse(ss.getItem("bb_muis"));
                }
                ...
                ss.removeItem("bb_muis");
                ss.setItem("bb_muis", JSON.stringify(items));
                $("#ic").text(count);
                xz();
            }
        });
    ...
    function reqData() {
        ...
        var m = ss.getItem("m");
        var mid = ${obj.mid};
        $.getJSON("${ctx}/sport/bb/match/" + t + "/" + mu + "/" + m + "/" + mid, function (o) {
            if (o.c == 0) {
                ...
                $.each(o.d[5], function (i, v) {
                    ...
                    var digits = 2;
                    if(v[0] == "2" || v[0] == "3" || v[0] == "4" || v[0] == "11" || v[0] == "12"){
                    	digits = 3;
                    }
    ...
    function xz() {
        if (ss.getItem("bb_muis") != null && ss.getItem("mu") == 1) {
            var items = JSON.parse(ss.getItem("bb_muis"));
            var ids = ",";
            for (var i = 0; i < items.length; i++) {
                ids += items[i].id + ",";
