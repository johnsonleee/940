		...
		<div class="ui-on-lottery">
		    ...
		    <div class="handicap-info">
  			...
  			<div data-role="navbar">
			    <ul>
			        <li><a href="#" ${obj.nav == 1 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeBetOn('ERZI_QS')">前三</a></li>
			        <li><a href="#" ${obj.nav == 2 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeBetOn('ERZI_ZS')">中三</a></li>
			        <li><a href="#" ${obj.nav == 3 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeBetOn('ERZI_HS')">后三</a></li>
			    </ul>
			</div>
