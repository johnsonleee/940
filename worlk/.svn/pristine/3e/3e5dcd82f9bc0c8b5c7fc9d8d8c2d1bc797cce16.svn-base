...
public class GameXGdsyxwAction {
	private Log log = Logs.getLog(GameXGdsyxwAction.class);

	@At("/ssc/gdsyxwmenu")
	@Ok("jsp:page.ssc.gdsyxw.gameGdsyxw")
	public Object gdsyxwmenu() {
	...
	public View topage(@Param("pageName") String pageName, @Param("gameId") String gameId, @Param("betOn") String betOn, @Param("nav") String nav) {
		...
		return new ViewWrapper(new JspView("page.ssc.gdsyxw." + pageName), dataMap);
	}
}
