...
$(function(){
    ...
    //游戏是否隐藏
    if("${obj.cf.hnklc_1}" != '' && "${obj.cf.hnklc_1}" != 1){
	   	$.each($("[id^='BALL_1-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }
    if("${obj.cf.hnklc_2}" != '' && "${obj.cf.hnklc_2}" != 1){
	   	$.each($("[id^='BALL_2-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }
    if("${obj.cf.hnklc_3}" != '' && "${obj.cf.hnklc_3}" != 1){
	   	$.each($("[id^='BALL_3-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }    
    if("${obj.cf.hnklc_4}" != '' && "${obj.cf.hnklc_4}" != 1){
	   	$.each($("[id^='BALL_4-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    } 
    if("${obj.cf.hnklc_5}" != '' && "${obj.cf.hnklc_5}" != 1){
	   	$.each($("[id^='BALL_5-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }  
    if("${obj.cf.hnklc_6}" != '' && "${obj.cf.hnklc_6}" != 1){
	   	$.each($("[id^='BALL_6-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }    
    if("${obj.cf.hnklc_7}" != '' && "${obj.cf.hnklc_7}" != 1){
	   	$.each($("[id^='BALL_7-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    } 
    if("${obj.cf.hnklc_8}" != '' && "${obj.cf.hnklc_8}" != 1){
...
<body>
	<section  data-role="page" id="rateInfoPage">
		...
		<div class="ui-on-lottery">	
		    ...
		    <c:if test = "${empty obj.cf || obj.cf.hnklc_zh == 1}">     			
