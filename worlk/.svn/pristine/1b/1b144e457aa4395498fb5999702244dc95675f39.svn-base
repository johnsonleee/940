	...
	<section data-role="page" id="lobby_gdsf">
		...
		<div data-role="content" class="ui-mt-10">
			<div data-role="listview" class="reset ui-listview-padding">
				...
				<li class="ui-mt-10"><a href="${ctx}/tjsf/topage?pageName=ballTjsf&gameId=TJKLC&betOn=BALL_1" title="${msg['label.ssc.play.BALL_1']}" data-transition="slide" data-ajax="false">${msg['label.ssc.play.BALL_1']}</a></li>
				</c:if>
				...
				<li class="ui-mt-10"><a href="${ctx}/tjsf/topage?pageName=serialTjsf&gameId=TJKLC&betOn=SERIAL_2&nav=1" title="${msg['title.ssc.LIANMA']}" data-transition="slide" data-ajax="false">${msg['title.ssc.LIANMA']}</a></li>
				</c:if>
			</div>
		</div>
	</section>
