    ...
    <div id="testt"></div>
        ...
        <div class="mainframe01">
            <div class="min-overflow">
                <div class="div01">
                    <div class="o-number title-setting brl-1">七色{[{5rOi}]}</div>
            ...
            <div class="div01">
                ...
                <div class="b-number brl-1"><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="ball" id="ball-147" data-mini="true"><label for="ball-147">0.00</label></fieldset></div>
                <div class="o-number line-color brl-1">蓝{[{5rOi}]}</div>
                <div class="b-number brl-1"><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="ball" id="ball-148" data-mini="true"><label for="ball-148">0.00</label></fieldset></div>
            </div>
            <div class="div02">
                <div class="o-number line-color brl-1">绿{[{5rOi}]}</div>
                <div class="b-number brl-1"><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="ball" id="ball-149" data-mini="true"><label for="ball-149">0.00</label></fieldset></div>
                <div class="o-number line-color brl-1">和局</div>
                <div class="b-number brl-1"><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="ball" id="ball-150" data-mini="true"><label for="ball-150">0.00</label></fieldset></div>
            </div>
