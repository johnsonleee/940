...
$(function(){
    ...
    //游戏是否隐藏
    if("${obj.cf.klc_1}" != '' && "${obj.cf.klc_1}" != 1){
	   	$.each($("[id^='BALL_1-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }
    if("${obj.cf.klc_2}" != '' && "${obj.cf.klc_2}" != 1){
	   	$.each($("[id^='BALL_2-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }
    if("${obj.cf.klc_3}" != '' && "${obj.cf.klc_3}" != 1){
	   	$.each($("[id^='BALL_3-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }    
    if("${obj.cf.klc_4}" != '' && "${obj.cf.klc_4}" != 1){
	   	$.each($("[id^='BALL_4-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    } 
    if("${obj.cf.klc_5}" != '' && "${obj.cf.klc_5}" != 1){
	   	$.each($("[id^='BALL_5-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }  
    if("${obj.cf.klc_6}" != '' && "${obj.cf.klc_6}" != 1){
	   	$.each($("[id^='BALL_6-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }    
    if("${obj.cf.klc_7}" != '' && "${obj.cf.klc_7}" != 1){
	   	$.each($("[id^='BALL_7-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    } 
    if("${obj.cf.klc_8}" != '' && "${obj.cf.klc_8}" != 1){
		...
		<div class="ui-on-lottery">		
			...
			<div class="list_dingtime">
		    	...
		    	<div class="table-cotent-lottery">
		    		<c:if test = "${empty obj.cf || obj.cf.klc_zh == 1}">     			
