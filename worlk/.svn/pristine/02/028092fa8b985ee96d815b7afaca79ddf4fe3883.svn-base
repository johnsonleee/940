    ...
    <div id="testt"></div>
        ...
        <div class="mainframe01">
            <div class="min-overflow">
                <div class="div01">
                    <div class="o-number title-setting brl-1">总{[{6IKW}]}</div>
            ...
            <div class="div01">
                <div class="o-number line-color brl-1">234{[{6IKW}]}</div>
                <div class="b-number brl-1"><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="ball" id="ball-141" data-mini="true"><label for="ball-141">0.00</label></fieldset></div>
                <div class="o-number line-color brl-1">5{[{6IKW}]}</div>
                <div class="b-number brl-1"><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="ball" id="ball-142" data-mini="true"><label for="ball-142">0.00</label></fieldset></div>
            </div>
            <div class="div02">
                <div class="o-number line-color brl-1">6{[{6IKW}]}</div>
                <div class="b-number brl-1"><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="ball" id="ball-143" data-mini="true"><label for="ball-143">0.00</label></fieldset></div>
                <div class="o-number line-color brl-1">7{[{6IKW}]}</div>
                <div class="b-number brl-1"><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="ball" id="ball-144" data-mini="true"><label for="ball-144">0.00</label></fieldset></div>
            </div>
            <div class="div01">
                <div class="o-number line-color brl-1">总{[{6IKW}]}{[{5Y2V}]}</div>
                <div class="b-number brl-1"><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="ball" id="ball-145" data-mini="true"><label for="ball-145">0.00</label></fieldset></div>
                <div class="o-number line-color brl-1">总{[{6IKW}]}{[{5Y+M}]}</div>
                <div class="b-number brl-1"><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="ball" id="ball-146" data-mini="true"><label for="ball-146">0.00</label></fieldset></div>
            </div>
