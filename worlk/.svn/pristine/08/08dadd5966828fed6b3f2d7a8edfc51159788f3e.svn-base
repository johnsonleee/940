			...
			<table border="1" class="hdptable">
			  ...
			  <tbody>
			    ...
			    <tr class="gxklc">
			      ...
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_1_NO_12" id="BALL_1_NO_12" data-mini="true"><label for="BALL_1_NO_12" title="${msg['label.ssc.play.BALL_1']} ${msg['label.ssc.ball.NO_12']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_2_NO_12" id="BALL_2_NO_12" data-mini="true"><label for="BALL_2_NO_12" title="${msg['label.ssc.play.BALL_2']} ${msg['label.ssc.ball.NO_12']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_3_NO_12" id="BALL_3_NO_12" data-mini="true"><label for="BALL_3_NO_12" title="${msg['label.ssc.play.BALL_3']} ${msg['label.ssc.ball.NO_12']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_4_NO_12" id="BALL_4_NO_12" data-mini="true"><label for="BALL_4_NO_12" title="${msg['label.ssc.play.BALL_4']} ${msg['label.ssc.ball.NO_12']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_5_NO_12" id="BALL_5_NO_12" data-mini="true"><label for="BALL_5_NO_12" title="${msg['label.ssc.play.BALL_5']} ${msg['label.ssc.ball.NO_12']}">0.00</label></fieldset></td>	
			    </tr>
			    <tr class="gxklc">
			      <td class="td-bgcolor"><span class="number num13"></span></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_1_NO_13" id="BALL_1_NO_13" data-mini="true"><label for="BALL_1_NO_13" title="${msg['label.ssc.play.BALL_1']} ${msg['label.ssc.ball.NO_13']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_2_NO_13" id="BALL_2_NO_13" data-mini="true"><label for="BALL_2_NO_13" title="${msg['label.ssc.play.BALL_2']} ${msg['label.ssc.ball.NO_13']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_3_NO_13" id="BALL_3_NO_13" data-mini="true"><label for="BALL_3_NO_13" title="${msg['label.ssc.play.BALL_3']} ${msg['label.ssc.ball.NO_13']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_4_NO_13" id="BALL_4_NO_13" data-mini="true"><label for="BALL_4_NO_13" title="${msg['label.ssc.play.BALL_4']} ${msg['label.ssc.ball.NO_13']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_5_NO_13" id="BALL_5_NO_13" data-mini="true"><label for="BALL_5_NO_13" title="${msg['label.ssc.play.BALL_5']} ${msg['label.ssc.ball.NO_13']}">0.00</label></fieldset></td>	
			    </tr>
			    <tr class="gxklc">
			      <td class="td-bgcolor"><span class="number num14"></span></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_1_NO_14" id="BALL_1_NO_14" data-mini="true"><label for="BALL_1_NO_14" title="${msg['label.ssc.play.BALL_1']} ${msg['label.ssc.ball.NO_14']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_2_NO_14" id="BALL_2_NO_14" data-mini="true"><label for="BALL_2_NO_14" title="${msg['label.ssc.play.BALL_2']} ${msg['label.ssc.ball.NO_14']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_3_NO_14" id="BALL_3_NO_14" data-mini="true"><label for="BALL_3_NO_14" title="${msg['label.ssc.play.BALL_3']} ${msg['label.ssc.ball.NO_14']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_4_NO_14" id="BALL_4_NO_14" data-mini="true"><label for="BALL_4_NO_14" title="${msg['label.ssc.play.BALL_4']} ${msg['label.ssc.ball.NO_14']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_5_NO_14" id="BALL_5_NO_14" data-mini="true"><label for="BALL_5_NO_14" title="${msg['label.ssc.play.BALL_5']} ${msg['label.ssc.ball.NO_14']}">0.00</label></fieldset></td>	
			    </tr>
			    <tr class="gxklc">
			      <td class="td-bgcolor"><span class="number num15"></span></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_1_NO_15" id="BALL_1_NO_15" data-mini="true"><label for="BALL_1_NO_15" title="${msg['label.ssc.play.BALL_1']} ${msg['label.ssc.ball.NO_15']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_2_NO_15" id="BALL_2_NO_15" data-mini="true"><label for="BALL_2_NO_15" title="${msg['label.ssc.play.BALL_2']} ${msg['label.ssc.ball.NO_15']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_3_NO_15" id="BALL_3_NO_15" data-mini="true"><label for="BALL_3_NO_15" title="${msg['label.ssc.play.BALL_3']} ${msg['label.ssc.ball.NO_15']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_4_NO_15" id="BALL_4_NO_15" data-mini="true"><label for="BALL_4_NO_15" title="${msg['label.ssc.play.BALL_4']} ${msg['label.ssc.ball.NO_15']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_5_NO_15" id="BALL_5_NO_15" data-mini="true"><label for="BALL_5_NO_15" title="${msg['label.ssc.play.BALL_5']} ${msg['label.ssc.ball.NO_15']}">0.00</label></fieldset></td>	
			    </tr>
			    <tr class="gxklc">
			      <td class="td-bgcolor"><span class="number num16"></span></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_1_NO_16" id="BALL_1_NO_16" data-mini="true"><label for="BALL_1_NO_16" title="${msg['label.ssc.play.BALL_1']} ${msg['label.ssc.ball.NO_16']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_2_NO_16" id="BALL_2_NO_16" data-mini="true"><label for="BALL_2_NO_16" title="${msg['label.ssc.play.BALL_2']} ${msg['label.ssc.ball.NO_16']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_3_NO_16" id="BALL_3_NO_16" data-mini="true"><label for="BALL_3_NO_16" title="${msg['label.ssc.play.BALL_3']} ${msg['label.ssc.ball.NO_16']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_4_NO_16" id="BALL_4_NO_16" data-mini="true"><label for="BALL_4_NO_16" title="${msg['label.ssc.play.BALL_4']} ${msg['label.ssc.ball.NO_16']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_5_NO_16" id="BALL_5_NO_16" data-mini="true"><label for="BALL_5_NO_16" title="${msg['label.ssc.play.BALL_5']} ${msg['label.ssc.ball.NO_16']}">0.00</label></fieldset></td>	
			    </tr>
			    <tr class="gxklc">
			      <td class="td-bgcolor"><span class="number num17"></span></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_1_NO_17" id="BALL_1_NO_17" data-mini="true"><label for="BALL_1_NO_17" title="${msg['label.ssc.play.BALL_1']} ${msg['label.ssc.ball.NO_17']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_2_NO_17" id="BALL_2_NO_17" data-mini="true"><label for="BALL_2_NO_17" title="${msg['label.ssc.play.BALL_2']} ${msg['label.ssc.ball.NO_17']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_3_NO_17" id="BALL_3_NO_17" data-mini="true"><label for="BALL_3_NO_17" title="${msg['label.ssc.play.BALL_3']} ${msg['label.ssc.ball.NO_17']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_4_NO_17" id="BALL_4_NO_17" data-mini="true"><label for="BALL_4_NO_17" title="${msg['label.ssc.play.BALL_4']} ${msg['label.ssc.ball.NO_17']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_5_NO_17" id="BALL_5_NO_17" data-mini="true"><label for="BALL_5_NO_17" title="${msg['label.ssc.play.BALL_5']} ${msg['label.ssc.ball.NO_17']}">0.00</label></fieldset></td>	
			    </tr>
			    <tr class="gxklc">
			      <td class="td-bgcolor"><span class="number num18"></span></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_1_NO_18" id="BALL_1_NO_18" data-mini="true"><label for="BALL_1_NO_18" title="${msg['label.ssc.play.BALL_1']} ${msg['label.ssc.ball.NO_18']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_2_NO_18" id="BALL_2_NO_18" data-mini="true"><label for="BALL_2_NO_18" title="${msg['label.ssc.play.BALL_2']} ${msg['label.ssc.ball.NO_18']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_3_NO_18" id="BALL_3_NO_18" data-mini="true"><label for="BALL_3_NO_18" title="${msg['label.ssc.play.BALL_3']} ${msg['label.ssc.ball.NO_18']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_4_NO_18" id="BALL_4_NO_18" data-mini="true"><label for="BALL_4_NO_18" title="${msg['label.ssc.play.BALL_4']} ${msg['label.ssc.ball.NO_18']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_5_NO_18" id="BALL_5_NO_18" data-mini="true"><label for="BALL_5_NO_18" title="${msg['label.ssc.play.BALL_5']} ${msg['label.ssc.ball.NO_18']}">0.00</label></fieldset></td>	
			    </tr>
			    <tr class="gxklc">
			      <td class="td-bgcolor"><span class="number num19"></span></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_1_NO_19" id="BALL_1_NO_19" data-mini="true"><label for="BALL_1_NO_19" title="${msg['label.ssc.play.BALL_1']} ${msg['label.ssc.ball.NO_19']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_2_NO_19" id="BALL_2_NO_19" data-mini="true"><label for="BALL_2_NO_19" title="${msg['label.ssc.play.BALL_2']} ${msg['label.ssc.ball.NO_19']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_3_NO_19" id="BALL_3_NO_19" data-mini="true"><label for="BALL_3_NO_19" title="${msg['label.ssc.play.BALL_3']} ${msg['label.ssc.ball.NO_19']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_4_NO_19" id="BALL_4_NO_19" data-mini="true"><label for="BALL_4_NO_19" title="${msg['label.ssc.play.BALL_4']} ${msg['label.ssc.ball.NO_19']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_5_NO_19" id="BALL_5_NO_19" data-mini="true"><label for="BALL_5_NO_19" title="${msg['label.ssc.play.BALL_5']} ${msg['label.ssc.ball.NO_19']}">0.00</label></fieldset></td>	
			    </tr>
			    <tr class="gxklc">
			      <td class="td-bgcolor"><span class="number num20"></span></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_1_NO_20" id="BALL_1_NO_20" data-mini="true"><label for="BALL_1_NO_20" title="${msg['label.ssc.play.BALL_1']} ${msg['label.ssc.ball.NO_20']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_2_NO_20" id="BALL_2_NO_20" data-mini="true"><label for="BALL_2_NO_20" title="${msg['label.ssc.play.BALL_2']} ${msg['label.ssc.ball.NO_20']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_3_NO_20" id="BALL_3_NO_20" data-mini="true"><label for="BALL_3_NO_20" title="${msg['label.ssc.play.BALL_3']} ${msg['label.ssc.ball.NO_20']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_4_NO_20" id="BALL_4_NO_20" data-mini="true"><label for="BALL_4_NO_20" title="${msg['label.ssc.play.BALL_4']} ${msg['label.ssc.ball.NO_20']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_5_NO_20" id="BALL_5_NO_20" data-mini="true"><label for="BALL_5_NO_20" title="${msg['label.ssc.play.BALL_5']} ${msg['label.ssc.ball.NO_20']}">0.00</label></fieldset></td>	
			    </tr>
			    <tr class="gxklc">
			      <td class="td-bgcolor"><span class="number num21"></span></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_1_NO_21" id="BALL_1_NO_21" data-mini="true"><label for="BALL_1_NO_21" title="${msg['label.ssc.play.BALL_1']} ${msg['label.ssc.ball.NO_21']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_2_NO_21" id="BALL_2_NO_21" data-mini="true"><label for="BALL_2_NO_21" title="${msg['label.ssc.play.BALL_2']} ${msg['label.ssc.ball.NO_21']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_3_NO_21" id="BALL_3_NO_21" data-mini="true"><label for="BALL_3_NO_21" title="${msg['label.ssc.play.BALL_3']} ${msg['label.ssc.ball.NO_21']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_4_NO_21" id="BALL_4_NO_21" data-mini="true"><label for="BALL_4_NO_21" title="${msg['label.ssc.play.BALL_4']} ${msg['label.ssc.ball.NO_21']}">0.00</label></fieldset></td>
			      <td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_5_NO_21" id="BALL_5_NO_21" data-mini="true"><label for="BALL_5_NO_21" title="${msg['label.ssc.play.BALL_5']} ${msg['label.ssc.ball.NO_21']}">0.00</label></fieldset></td>	
			    </tr>
			  </tbody>
			</table>
			</div>
