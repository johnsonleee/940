...
<script type="text/javascript">
    ...
    function reqData(){
        ...
        var t = ss.getItem("t");
        var h = ss.getItem("h");
        $.getJSON("${ctx}/sport/bb/t/" + t + "/mu/" + mu + "/h/" + h, function (o) {
            if (o.c == 0) {
                var list = $("#liList");
                list.empty();
                for (var i = 0; i < o.d.length; i++) {
                    list.append($("<li><a style='white-space: normal !important;' menu href='${ctx}/sport/bb/league/" + o.d[i][0] + "' title='" + o.d[i][1] + "' data-transition='slide' data-ajax='false'>" + o.d[i][1] + "<span class='ui-li-count'>" + o.d[i][2] + "</span></a></li>"));
                }
