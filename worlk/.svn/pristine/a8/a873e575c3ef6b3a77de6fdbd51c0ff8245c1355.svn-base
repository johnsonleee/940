...
public class GameTjsfAction {
    private Log log = Logs.getLog(GameTjsfAction.class);
    ...
    public View topage(@Param("pageName") String pageName,
        ...
        return new ViewWrapper(new JspView("page.ssc.tjsf." + pageName), dataMap);
    }
    
    @At("/ssc/tjsfmenu")
    @Ok("jsp:page.ssc.tjsf.gameTjsf")
