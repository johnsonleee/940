...
function loadAfficheInfo() {
	...
	request.fail(function(jqXHR, textStatus, errorThrown) {
		if(textStatus == 'error'){
			afficheInfoListView.html('<h5 class="ui-bar ui-bar-b ui-corner-all content-info" style="text-align: center;">网络{[{5Lit}]}断,请检测网络</h5>');
  ...
  <div data-role="content">
	<ol data-role="listview" class="reset" id="afficheInfoListView">
	  ...
	  <li><strong>2014-6-9 18:48:31</strong>
	  	<p style="white-space:pre-wrap;">香港六{[{5ZCI}]}彩2014118{[{5pyf}]}于10月14{[{5Y+3}]}星{[{5pyf}]}二{[{5Lit}]}午12:00開盤，21：31封盤，21:35開獎,如有時間變動請以马会開獎時間為準！; </p>
	  </li>
	   -->
	</ol>
  </div>  
