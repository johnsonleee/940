...
public class GameSdssAction {
    private Log log = Logs.getLog(GameSdssAction.class);
    ...
    public View topage(@Param("pageName") String pageName,
        ...
        return new ViewWrapper(new JspView("page.ssc.sdsyxw." + pageName), dataMap);
    }
    
    @At("/ssc/sdsyxwmenu")
    @Ok("jsp:page.ssc.sdsyxw.gameSdsyxw")
