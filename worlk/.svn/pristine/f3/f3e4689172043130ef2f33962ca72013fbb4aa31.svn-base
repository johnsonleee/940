...
public class GameShsyxwAction {
	private Log log = Logs.getLog(GameShsyxwAction.class);
	...
	public View topage(@Param("pageName") String pageName, @Param("gameId") String gameId, @Param("betOn") String betOn, @Param("nav") String nav) {
		...
		return new ViewWrapper(new JspView("page.ssc.shsyxw." + pageName), dataMap);
	}

	@At("/ssc/shsyxwmenu")
	@Ok("jsp:page.ssc.shsyxw.gameShsyxw")
	public Object shsyxwmenu() {
