...
$(function(){
   ...
   //游戏是否隐藏
    if("${obj.cf.tjssc_1}" != '' && "${obj.cf.tjssc_1}" != 1){
	   	$.each($("[id^='BALL_1-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }
    if("${obj.cf.tjssc_2}" != '' && "${obj.cf.tjssc_2}" != 1){
	   	$.each($("[id^='BALL_2-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }
    if("${obj.cf.tjssc_3}" != '' && "${obj.cf.tjssc_3}" != 1){
	   	$.each($("[id^='BALL_3-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }    
    if("${obj.cf.tjssc_4}" != '' && "${obj.cf.tjssc_4}" != 1){
	   	$.each($("[id^='BALL_4-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    } 
    if("${obj.cf.tjssc_5}" != '' && "${obj.cf.tjssc_5}" != 1){
...
<body>
	<section  data-role="page" id="rateInfoPage" data-eventbind="N">
		...
		<div class="ui-on-lottery">	
		    ...
		    <c:if test = "${empty obj.cf || obj.cf.tjssc_zh == 1}">    
