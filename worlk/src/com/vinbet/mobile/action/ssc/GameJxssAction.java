...
public class GameJxssAction {
	private Log log = Logs.getLog(GameJxssAction.class);

	@At("/ssc/jxssmenu")
	@Ok("jsp:page.ssc.jxss.gameJxss")
	...
	public View topage(@Param("pageName") String pageName, @Param("gameId") String gameId, @Param("betOn") String betOn, @Param("nav") String nav) {
		...
		return new ViewWrapper(new JspView("page.ssc.jxss." + pageName), dataMap);
	}
}
