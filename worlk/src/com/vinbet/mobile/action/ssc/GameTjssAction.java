...
public class GameTjssAction {
    private Log log = Logs.getLog(GameTjssAction.class);

    @At("/tjss/topage")
    public View topage(@Param("pageName") String pageName,
                       @Param("gameId") String gameId, @Param("betOn") String betOn, @Param("nav") String nav) {
        Map<String, Object> dataMap = new HashMap<String, Object>();
        dataMap.put("gameId", gameId);
        dataMap.put("betOn", betOn);
        dataMap.put("nav", nav);
        dataMap.put("cf", AppCache.sscSysConfig);
        return new ViewWrapper(new JspView("page.ssc.tjss." + pageName), dataMap);
    }
    
    @At("/ssc/tjssmenu")
    @Ok("jsp:page.ssc.tjss.gameTjss")
