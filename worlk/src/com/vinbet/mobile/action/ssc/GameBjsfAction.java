...
public class GameBjsfAction {
	private Log log = Logs.getLog(GameBjsfAction.class);
	...
	public View topage(@Param("pageName") String pageName, @Param("gameId") String gameId, @Param("betOn") String betOn, @Param("nav") String nav) {
		...
		return new ViewWrapper(new JspView("page.ssc.bjsf." + pageName), dataMap);
	}

	@At("/ssc/bjsfmenu")
	@Ok("jsp:page.ssc.bjsf.gameBjsf")
