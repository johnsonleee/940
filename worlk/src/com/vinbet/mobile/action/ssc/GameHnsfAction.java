...
public class GameHnsfAction {
	private Log log = Logs.getLog(GameHnsfAction.class);
	...
	public View topage(@Param("pageName") String pageName, @Param("gameId") String gameId, @Param("betOn") String betOn, @Param("nav") String nav) {
		...
		return new ViewWrapper(new JspView("page.ssc.hnsf." + pageName), dataMap);
	}

	@At("/ssc/hnsfmenu")
	@Ok("jsp:page.ssc.hnsf.gameHnsf")
