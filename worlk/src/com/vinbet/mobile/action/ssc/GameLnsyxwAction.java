...
public class GameLnsyxwAction {
	private Log log = Logs.getLog(GameLnsyxwAction.class);
	...
	public View topage(@Param("pageName") String pageName, @Param("gameId") String gameId, @Param("betOn") String betOn, @Param("nav") String nav) {
		...
		return new ViewWrapper(new JspView("page.ssc.lnsyxw." + pageName), dataMap);
	}

	@At("/ssc/lnsyxwmenu")
	@Ok("jsp:page.ssc.lnsyxw.gameLnsyxw")
