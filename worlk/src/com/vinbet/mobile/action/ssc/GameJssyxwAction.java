...
public class GameJssyxwAction {
	private Log log = Logs.getLog(GameJssyxwAction.class);
	...
	public View topage(@Param("pageName") String pageName, @Param("gameId") String gameId, @Param("betOn") String betOn, @Param("nav") String nav) {
		...
		return new ViewWrapper(new JspView("page.ssc.jssyxw." + pageName), dataMap);
	}

	@At("/ssc/jssyxwmenu")
	@Ok("jsp:page.ssc.jssyxw.gameJssyxw")
