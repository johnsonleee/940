...
public class GameGxsfAction {
	private Log log = Logs.getLog(GameGxsfAction.class);
	...
	public View topage(@Param("pageName") String pageName, @Param("gameId") String gameId, @Param("betOn") String betOn, @Param("nav") String nav) {
		...
		return new ViewWrapper(new JspView("page.ssc.gxsf." + pageName), dataMap);
	}

	@At("/ssc/gxsfmenu")
	@Ok("jsp:page.ssc.gxsf.gameGxsf")
