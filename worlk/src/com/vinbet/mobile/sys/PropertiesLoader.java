...
public class PropertiesLoader {
	...
	public PropertiesLoader(boolean utf8) {
		this.utf8 = utf8;
	}
	...
	public PropertiesLoader(InputStream in) {
		this(true);
		try {
	 ...
	 * @since 1.b.50
	 */
	public PropertiesLoader(Reader r) {
		this(true);
		try {
			mp = new MultiLineProperties();
			mp.load(r);
	...
	public PropertiesLoader set(String key, String val) {
		put(key, val);
		return this;
	}
	 ...
	 * @return 自身
	 */
	public PropertiesLoader joinByKey(String key) {
		String str = get(key);
		final PropertiesLoader me = this;
	 ...
	 * @return 自身
	 */
	public PropertiesLoader joinAndClose(Reader r) {
