...
<div data-role="page" id="main">
	<div data-role="header" data-theme="b">
		...
		<h2>时时彩信息</h2>
		<a href="javascript:findSscinfo();" data-ajax="false" data-icon="refresh" class="ui-btn-right">查询</a>
	</div>
...
function findSscinfo() {
	showLoader("加载中...");
    var detailTable = $("#infoTable");
    $.ajax({
        url: '${ctx}/sys/findSscinfo',
            	...
            	if("true" == $("#sum").val()){
	                ...
	                if (arr != undefined && arr.length > 0) { 
	                    $.each(arr, function(key, value) {
	                    	var datatr ="<tr><td>" + value.gid + "</td><td>" + value.issue + "</td><td>" + value.uname + "</td><td>" + value.amount + "</td><td>" + value.time + "</td><td>" + value.year+"/"+value.month+"/"+value.day + "</td></tr>";
