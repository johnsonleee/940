...
<body>
	<c:set var="title" value="{[{5Y2K5Y2K5rOi}]}" />
		...
		<div data-role="main" class="ui-content">
			...
			<div class="table-cotent-lottery">
				 <div class="ui-field-contain"
					style="padding: 0 2px 0 2px; margin: 0.25em 0;display: none;">
				...
				<div class="mainframe01" id="numbers">
					<div class="min-overflow">
						<div class="type-hk1-t title-setting brl-1">{[{5Y2K5Y2K5rOi}]}</div>
			...
			<a href="#"
				onclick="javascript:$('html, body').animate({'scrollTop': 0 }, 300);"
				data-role="button" data-theme="top">返回顶部</a>
			</p>
		</div>
	</div>
...
<script type="text/javascript">
    ...
    function initNumbers() {
        var i = 0;
        while (i < hkcutil.banbanbo.length) {
            var method = hkcutil.banbanbo[i][0];
            var en = hkcutil.banbanbo[i][2];
            var cn = replaceAllHtml(hkcutil.banbanbo[i][1]);
            ...
            html += "</div></div>";
            html += "<div class='value-kh1 brl-1 " + (i == hkcutil.banbanbo.length - 1 ? "border-b01" : "") + "'><fieldset data-role='controlgroup' data-type='horizontal'><input type='checkbox' name='" + en + "' id='" + en + "' cn='" + cn + "' data-mini='true'><label for='" + en + "' title='" + cn + "'>0.00</label></fieldset></div>";
            if (i == hkcutil.banbanbo.length - 1) {
