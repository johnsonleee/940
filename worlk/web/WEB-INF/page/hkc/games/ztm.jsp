...
<body>
<c:set var="title" value="{[{5q2j56CB}]}{[{54m5}]}" />
<div data-role="page" id="choosePage">
    ...
    <div data-role="main" class="ui-content">
        ...
        <div data-role="navbar" pid="12" data-mini="true">
            <ul>
        ...
        <div class="mainframe01">
            ...
            <div class="div01">
                <div class="o-number line-color brl-1">{[{5ZCI}]}{[{5Y2V}]}</div>
                ...
                <div class="o-number line-color brl-1">{[{5ZCI}]}{[{5Y+M}]}</div>
            ...
            <div class="div01">
                <div class="o-number line-color brl-1">红{[{5rOi}]}</div>
                ...
                <div class="o-number line-color brl-1">蓝{[{5rOi}]}</div>
            ...
            <div class="div02">
                <div class="o-number line-color brl-1">绿{[{5rOi}]}</div>
