...
<body>
<c:set var="title" value="{[{5q2j56CB}]}" />
<div data-role="page" id="choosePage">
    ...
    <div data-role="main" class="ui-content">
        ...
        <div data-role="navbar" pid="11" data-mini="true">
            <ul>
        ...
        <div class="mainframe01">
            ...
            <div class="div01">
                <div class="o-number line-color brl-1">总{[{5Y2V}]}</div>
                <div class="o-number brl-1"><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="ball" id="ball-61" data-mini="true"><label for="ball-61">0.00</label></fieldset></div>
                <div class="o-number line-color brl-1">总{[{5Y+M}]}</div>
                <div class="o-number brl-1"><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="ball" id="ball-62" data-mini="true"><label for="ball-62">0.00</label></fieldset></div>
            </div>
            <div class="div02">
                <div class="o-number line-color brl-1">总{[{5aSn}]}</div>
                <div class="o-number brl-1"><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="ball" id="ball-63" data-mini="true"><label for="ball-63">0.00</label></fieldset></div>
                <div class="o-number line-color brl-1">总{[{5bCP}]}</div>
                <div class="o-number brl-1 border-b01"><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="ball" id="ball-64" data-mini="true"><label for="ball-64">0.00</label></fieldset></div>
            </div>
...
<div data-role="page" id="fastChoosePage">
    ...
    <div data-role="main" class="ui-content-ks">
        ...
        <div class="divider">
            <div class="float-controler">
                <div class="round-select" name="csb" id="getSumSingle">{[{5ZCI}]}{[{5Y2V}]}</div>
            </div>
            <div class="float-controler">
                <div class="round-select" name="csb" id="getSumDouble">{[{5ZCI}]}{[{5Y+M}]}</div>
            </div>
            <div class="float-controler">
                <div class="round-select" name="csb" id="getTailBig">{[{5bC+}]}{[{5aSn}]}</div>
            </div>
            <div class="float-controler">
                <div class="round-select" name="csb" id="getTailSmall">{[{5bC+}]}{[{5bCP}]}</div>
            </div>
        </div>
        <div class="divider">
            <div class="float-controler">
                <div class="round-select" name="csb" id="getRedBall">红{[{5rOi}]}</div>
            </div>
            <div class="float-controler">
                <div class="round-select" name="csb" id="getGreenBall">绿{[{5rOi}]}</div>
            </div>
            <div class="float-controler">
                <div class="round-select" name="csb" id="getBlueBall">蓝{[{5rOi}]}</div>
            </div>
        </div>
        <div class="divider">
            <div class="float-controler">
                <div class="round-select" name="csb" id="getRedSingle">红{[{5Y2V}]}</div>
            </div>
            <div class="float-controler">
                <div class="round-select" name="csb" id="getRedDouble">红{[{5Y+M}]}</div>
            </div>
            <div class="float-controler">
                <div class="round-select" name="csb" id="getRedBig">红{[{5aSn}]}</div>
            </div>
            <div class="float-controler">
                <div class="round-select" name="csb" id="getRedSmall">红{[{5bCP}]}</div>
            </div>
        </div>
        <div class="divider">
            <div class="float-controler">
                <div class="round-select" name="csb" id="getGreenSingle">绿{[{5Y2V}]}</div>
            </div>
            <div class="float-controler">
                <div class="round-select" name="csb" id="getGreenDouble">绿{[{5Y+M}]}</div>
            </div>
            <div class="float-controler">
                <div class="round-select" name="csb" id="getGreenBig">绿{[{5aSn}]}</div>
            </div>
            <div class="float-controler">
                <div class="round-select" name="csb" id="getGreenSmall">绿{[{5bCP}]}</div>
            </div>
        </div>
        <div class="divider">
            <div class="float-controler">
                <div class="round-select" name="csb" id="getBlueSingle">蓝{[{5Y2V}]}</div>
            </div>
            <div class="float-controler">
                <div class="round-select" name="csb" id="getBlueDouble">蓝{[{5Y+M}]}</div>
            </div>
            <div class="float-controler">
                <div class="round-select" name="csb" id="getBlueBig">蓝{[{5aSn}]}</div>
            </div>
            <div class="float-controler">
                <div class="round-select" name="csb" id="getBlueSmall">蓝{[{5bCP}]}</div>
            </div>
        </div>
        <div class="divider">
            <div class="float-controler">
