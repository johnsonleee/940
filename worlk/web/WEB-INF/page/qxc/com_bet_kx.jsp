...
<div data-role="page" id="toBet" data-eventbind="N">
	...
	<form action="${ctx}/qxc/addOrder" data-ajax="false">
		...
		<input type="hidden" id="pgameCode" name="pgameCode" value=""/>
				...
				<table width="100%" border="0" id="orderTable" cellpadding="0" cellspacing="0" style="border:none; width:100%;">
					<thead>
						<tr class="trhight" style="border:none;">
							<td class="titled" colspan="2" style="border:none;font-size:12px;"> {[{5pyf}]}数: <span id="isid"></span><%-- &nbsp;&nbsp;盘口: <span id="nowHandType">A盘</span> --%></td>
						</tr>
					</thead>
					<tbody>
					</tbody>
	...
	<div data-role="footer" class="ui-footer ui-footer-fixed">
		<div class= "ui-grid-a">
		 <div class= "ui-btn5 ui-block-a">
			<a href="#" id="cancelBtn" onclick="toRate_kx()" data-rel="page" style="background:none; border:none; box-shadow:none; width:90%; " class="ui-btn" data-ajax="false">取消</a>
		 </div>
