...
<body>
	<div data-role="page" id="rateInfoPage">
		...
		<c:set var="page_title" value="二{[{5a6a}]}位" />
	        ...
	        <div data-role="navbar">
			    ...
			    <ul>
			   		<c:if test = "${empty obj.gcl || fn:contains(obj.gcl,'3301')}">
				    	<li><a href="#" ${obj.gameCode == 3301 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeGame('3301')">口口XX</a></li>
				    </c:if>
				    <c:if test = "${empty obj.gcl || fn:contains(obj.gcl,'3302')}">
				    	<li><a href="#" ${obj.gameCode == 3302 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeGame('3302')">口X口X</a></li>
				    </c:if>
				    <c:if test = "${empty obj.gcl || fn:contains(obj.gcl,'3303')}">
				    	<li><a href="#" ${obj.gameCode == 3303 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeGame('3303')">口XX口</a></li>
			    	</c:if>
			    </ul>
			    </c:if>
			    ...
			    <ul>
			    	<c:if test = "${empty obj.gcl || fn:contains(obj.gcl,'3304')}">
				    	<li><a href="#" ${obj.gameCode == 3304 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeGame('3304')">X口口X</a></li>
				    </c:if>
				    <c:if test = "${empty obj.gcl || fn:contains(obj.gcl,'3305')}">
				    	<li><a href="#" ${obj.gameCode == 3305 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeGame('3305')">X口X口</a></li>
					</c:if>
				    <c:if test = "${empty obj.gcl || fn:contains(obj.gcl,'3306')}">
				    	<li><a href="#" ${obj.gameCode == 3306 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeGame('3306')">XX口口</a></li>
			    	</c:if>
			    </ul>
			    </c:if>
			</div>
