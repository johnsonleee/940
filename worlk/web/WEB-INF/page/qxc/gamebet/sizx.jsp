...
<body>
	<div data-role="page" id="rateInfoPage">
		...
		<c:set var="page_title" value="四{[{5a2X}]}现" />
			    ...
			    <ul>
			    	<li>
				        <select id="px_v" onchange="changePX()">
							<option value="1">0000~0355</option>
							<option value="2">0356~1289</option>
							<option value="3">1299~2444</option>
							<option value="4">2445~4459</option>
							<option value="5">4466~9999</option>
						</select>
					</li>
				</ul>
			</div>
		...
		<div class="clear"></div>
		<p><a href="#" onclick="javascript:$('html, body').animate({'scrollTop': 0 }, 500);" class="ui-btn-top" data-role="button">返回顶部</a></p><!-- 回到顶部 -->
		</div>
		</div>
	</div>
