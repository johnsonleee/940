...
<body>
	<div data-role="page" id="rateInfoPage">
		...
		<c:set var="page_title" value="多{[{6YCJ5Lit5LiA}]}" />
		...
		<div data-role="content" id="rateRefInfo">
	        ...
	        <div data-role="navbar">
	        	<c:if test = "${empty obj.gcl || fn:contains(obj.gcl,'4801') || fn:contains(obj.gcl,'4802') || fn:contains(obj.gcl,'4803') || fn:contains(obj.gcl,'4804')}">
			    <ul>
			   		<c:if test = "${empty obj.gcl || fn:contains(obj.gcl,'4801')}">
				    	<li><a href="#" ${obj.gameCode == 4801 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeGame('4801')">二{[{6YCJ5Lit5LiA}]}</a></li>
				    </c:if>
				    <c:if test = "${empty obj.gcl || fn:contains(obj.gcl,'4802')}">
				    	<li><a href="#" ${obj.gameCode == 4802 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeGame('4802')">三{[{6YCJ5Lit5LiA}]}</a></li>
				    </c:if>
				    <c:if test = "${empty obj.gcl || fn:contains(obj.gcl,'4803')}">
				    	<li><a href="#" ${obj.gameCode == 4803 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeGame('4803')">四{[{6YCJ5Lit5LiA}]}</a></li>
				    </c:if>
				    <c:if test = "${empty obj.gcl || fn:contains(obj.gcl,'4804')}">
				    	<li><a href="#" ${obj.gameCode == 4804 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeGame('4804')">五{[{6YCJ5Lit5LiA}]}</a></li>
					</c:if>
			    </ul>
			    </c:if>
			</div>
