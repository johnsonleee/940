...
$(function(){
    ...
    //游戏是否隐藏
    if("${obj.cf.xync_1}" != '' && "${obj.cf.xync_1}" != 1){
	   	$.each($("[id^='BALL_1-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }
    if("${obj.cf.xync_2}" != '' && "${obj.cf.xync_2}" != 1){
	   	$.each($("[id^='BALL_2-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }
    if("${obj.cf.xync_3}" != '' && "${obj.cf.xync_3}" != 1){
	   	$.each($("[id^='BALL_3-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }    
    if("${obj.cf.xync_4}" != '' && "${obj.cf.xync_4}" != 1){
	   	$.each($("[id^='BALL_4-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    } 
    if("${obj.cf.xync_5}" != '' && "${obj.cf.xync_5}" != 1){
	   	$.each($("[id^='BALL_5-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }  
    if("${obj.cf.xync_6}" != '' && "${obj.cf.xync_6}" != 1){
	   	$.each($("[id^='BALL_6-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }    
    if("${obj.cf.xync_7}" != '' && "${obj.cf.xync_7}" != 1){
	   	$.each($("[id^='BALL_7-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    } 
    if("${obj.cf.xync_8}" != '' && "${obj.cf.xync_8}" != 1){
...
<body>
	<section  data-role="page" id="rateInfoPage">
		...
		<div class="ui-on-lottery">	
		    ...
		    <c:if test = "${empty obj.cf || obj.cf.xync_zh == 1}">
