		...
		<div class="ui-on-lottery">	
		    ...
		    <div class="handicap-info">
  			...
  			<div data-role="navbar">
			    <ul>
			        <li><a href="#" ${obj.nav == 1 ? "class='ui-btn-active'" : ""} onclick="changeBetOn('SERIAL_2')" data-ajax="false">${msg['label.ssc.play.SERIAL_2']}</a></li>
			        ...
			        <li><a href="#" ${obj.nav == 2 ? "class='ui-btn-active'" : ""} onclick="changeBetOn('SERIAL_2_Z')" data-ajax="false">${msg['label.ssc.play.SERIAL_2_Z']}</a></li>
			        <li><a href="#" ${obj.nav == 3 ? "class='ui-btn-active'" : ""} onclick="changeBetOn('SERIAL_3')" data-ajax="false">${msg['label.ssc.play.SERIAL_3']}</a></li>
			    </ul>
			    <ul>
			    	<li><a href="#" ${obj.nav == 4 ? "class='ui-btn-active'" : ""} onclick="changeBetOn('SERIAL_3_Z')" data-ajax="false">${msg['label.ssc.play.SERIAL_3_Z']}</a></li>
			        <li><a href="#" ${obj.nav == 5 ? "class='ui-btn-active'" : ""} onclick="changeBetOn('SERIAL_4')" data-ajax="false">${msg['label.ssc.play.SERIAL_4']}</a></li>
			        <li><a href="#" ${obj.nav == 6 ? "class='ui-btn-active'" : ""} onclick="changeBetOn('SERIAL_5')" data-ajax="false">${msg['label.ssc.play.SERIAL_5']}</a></li>
			        <li>&nbsp;&nbsp;</li>
			    </ul>
			</div>
