...
$(function(){
    ...
    //游戏是否隐藏
    if("${obj.cf.tjklc_1}" != '' && "${obj.cf.tjklc_1}" != 1){
	   	$.each($("[id^='BALL_1-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }
    if("${obj.cf.tjklc_2}" != '' && "${obj.cf.tjklc_2}" != 1){
	   	$.each($("[id^='BALL_2-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }
    if("${obj.cf.tjklc_3}" != '' && "${obj.cf.tjklc_3}" != 1){
	   	$.each($("[id^='BALL_3-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }    
    if("${obj.cf.tjklc_4}" != '' && "${obj.cf.tjklc_4}" != 1){
	   	$.each($("[id^='BALL_4-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    } 
    if("${obj.cf.tjklc_5}" != '' && "${obj.cf.tjklc_5}" != 1){
	   	$.each($("[id^='BALL_5-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }  
    if("${obj.cf.tjklc_6}" != '' && "${obj.cf.tjklc_6}" != 1){
	   	$.each($("[id^='BALL_6-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }    
    if("${obj.cf.tjklc_7}" != '' && "${obj.cf.tjklc_7}" != 1){
	   	$.each($("[id^='BALL_7-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    } 
    if("${obj.cf.tjklc_8}" != '' && "${obj.cf.tjklc_8}" != 1){
	   	$.each($("[id^='BALL_8-']"), function(){
	   		$(this).parent().parent().hide();
	   	});    
    }
...
<body>
	<section  data-role="page" id="rateInfoPage">
		...
		<div class="ui-on-lottery">		
		    ...
		    <c:if test = "${empty obj.cf || obj.cf.tjklc_zh == 1}">     			
			...
			<table border="1" class="hdptable">
			  ...
			  <tbody>
			  	...
			  	<tr>
			  		...
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_1-DRAGON" id="BALL_1-DRAGON" data-mini="true"><label title="${msg['label.ssc.play.BALL_1']}${msg['label.ssc.ball.DRAGON']}" for="BALL_1-DRAGON">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_2-DRAGON" id="BALL_2-DRAGON" data-mini="true"><label title="${msg['label.ssc.play.BALL_2']}${msg['label.ssc.ball.DRAGON']}" for="BALL_2-DRAGON">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_3-DRAGON" id="BALL_3-DRAGON" data-mini="true"><label title="${msg['label.ssc.play.BALL_3']}${msg['label.ssc.ball.DRAGON']}" for="BALL_3-DRAGON">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_4-DRAGON" id="BALL_4-DRAGON" data-mini="true"><label title="${msg['label.ssc.play.BALL_4']}${msg['label.ssc.ball.DRAGON']}" for="BALL_4-DRAGON">0.00</label></fieldset></td>
			  	</tr>
			  	<tr>
			  		<td class="td-bgcolor">${msg['label.ssc.ball.TIGER']}</td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_1-TIGER" id="BALL_1-TIGER" data-mini="true"><label title="${msg['label.ssc.play.BALL_1']}${msg['label.ssc.ball.TIGER']}" for="BALL_1-TIGER">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_2-TIGER" id="BALL_2-TIGER" data-mini="true"><label title="${msg['label.ssc.play.BALL_2']}${msg['label.ssc.ball.TIGER']}" for="BALL_2-TIGER">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_3-TIGER" id="BALL_3-TIGER" data-mini="true"><label title="${msg['label.ssc.play.BALL_3']}${msg['label.ssc.ball.TIGER']}" for="BALL_3-TIGER">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_4-TIGER" id="BALL_4-TIGER" data-mini="true"><label title="${msg['label.ssc.play.BALL_4']}${msg['label.ssc.ball.TIGER']}" for="BALL_4-TIGER">0.00</label></fieldset></td>
			  	</tr>
			  </tbody>
			</table>
			<table border="1" class="hdptable">
			  <thead>
			    <tr class="tr-bgcolor">
			      ...
			      <th>${msg['label.ssc.play.BALL_6']}</th>
			      <th>${msg['label.ssc.play.BALL_7']}</th>
			      <th>${msg['label.ssc.play.BALL_8']}</th>
			    </tr>
			  </thead>
			  <tbody>
			  	<tr>
			  		...
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_6-BIG" id="BALL_6-BIG" data-mini="true"><label title="${msg['label.ssc.play.BALL_6']}${msg['label.ssc.ball.BIG']}" for="BALL_6-BIG">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_7-BIG" id="BALL_7-BIG" data-mini="true"><label title="${msg['label.ssc.play.BALL_7']}${msg['label.ssc.ball.BIG']}" for="BALL_7-BIG">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_8-BIG" id="BALL_8-BIG" data-mini="true"><label title="${msg['label.ssc.play.BALL_8']}${msg['label.ssc.ball.BIG']}" for="BALL_8-BIG">0.00</label></fieldset></td>
			  	</tr>
			  	<tr>
			  		<td class="td-bgcolor">${msg['label.ssc.ball.SMALL']}</td>
					...
					<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_6-SMALL" id="BALL_6-SMALL" data-mini="true"><label title="${msg['label.ssc.play.BALL_6']}${msg['label.ssc.ball.SMALL']}" for="BALL_6-SMALL">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_7-SMALL" id="BALL_7-SMALL" data-mini="true"><label title="${msg['label.ssc.play.BALL_7']}${msg['label.ssc.ball.SMALL']}" for="BALL_7-SMALL">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_8-SMALL" id="BALL_8-SMALL" data-mini="true"><label title="${msg['label.ssc.play.BALL_8']}${msg['label.ssc.ball.SMALL']}" for="BALL_8-SMALL">0.00</label></fieldset></td>
			  	</tr>
			  	<tr>
			  		<td class="td-bgcolor">${msg['label.ssc.ball.ODD']}</td>
			  		...
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_6-ODD" id="BALL_6-ODD" data-mini="true"><label title="${msg['label.ssc.play.BALL_6']}${msg['label.ssc.ball.ODD']}" for="BALL_6-ODD">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_7-ODD" id="BALL_7-ODD" data-mini="true"><label title="${msg['label.ssc.play.BALL_7']}${msg['label.ssc.ball.ODD']}" for="BALL_7-ODD">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_8-ODD" id="BALL_8-ODD" data-mini="true"><label title="${msg['label.ssc.play.BALL_8']}${msg['label.ssc.ball.ODD']}" for="BALL_8-ODD">0.00</label></fieldset></td>
			  	</tr>
			  	<tr>
			  		<td class="td-bgcolor">${msg['label.ssc.ball.EVEN']}</td>
			  		...
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_6-EVEN" id="BALL_6-EVEN" data-mini="true"><label title="${msg['label.ssc.play.BALL_6']}${msg['label.ssc.ball.EVEN']}" for="BALL_6-EVEN">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_7-EVEN" id="BALL_7-EVEN" data-mini="true"><label title="${msg['label.ssc.play.BALL_7']}${msg['label.ssc.ball.EVEN']}" for="BALL_7-EVEN">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_8-EVEN" id="BALL_8-EVEN" data-mini="true"><label title="${msg['label.ssc.play.BALL_8']}${msg['label.ssc.ball.EVEN']}" for="BALL_8-EVEN">0.00</label></fieldset></td>
			  	</tr>
			  	<tr>
			  		<td class="td-bgcolor">${msg['label.ssc.ball.TAIL_BIG']}</td>
			  		...
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_6-TAIL_BIG" id="BALL_6-TAIL_BIG" data-mini="true"><label title="${msg['label.ssc.play.BALL_6']}${msg['label.ssc.ball.TAIL_BIG']}" for="BALL_6-TAIL_BIG">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_7-TAIL_BIG" id="BALL_7-TAIL_BIG" data-mini="true"><label title="${msg['label.ssc.play.BALL_7']}${msg['label.ssc.ball.TAIL_BIG']}" for="BALL_7-TAIL_BIG">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_8-TAIL_BIG" id="BALL_8-TAIL_BIG" data-mini="true"><label title="${msg['label.ssc.play.BALL_8']}${msg['label.ssc.ball.TAIL_BIG']}" for="BALL_8-TAIL_BIG">0.00</label></fieldset></td>
			  	</tr>
			  	<tr>
			  		<td class="td-bgcolor">${msg['label.ssc.ball.TAIL_SMALL']}</td>
			  		...
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_6-TAIL_SMALL" id="BALL_6-TAIL_SMALL" data-mini="true"><label title="${msg['label.ssc.play.BALL_6']}${msg['label.ssc.ball.TAIL_SMALL']}" for="BALL_6-TAIL_SMALL">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_7-TAIL_SMALL" id="BALL_7-TAIL_SMALL" data-mini="true"><label title="${msg['label.ssc.play.BALL_7']}${msg['label.ssc.ball.TAIL_SMALL']}" for="BALL_7-TAIL_SMALL">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_8-TAIL_SMALL" id="BALL_8-TAIL_SMALL" data-mini="true"><label title="${msg['label.ssc.play.BALL_8']}${msg['label.ssc.ball.TAIL_SMALL']}" for="BALL_8-TAIL_SMALL">0.00</label></fieldset></td>
			  	</tr>
			  	<tr>
			  		<td class="td-bgcolor">${msg['label.ssc.ball.SUM_ODD']}</td>
			  		...
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_6-SUM_ODD" id="BALL_6-SUM_ODD" data-mini="true"><label title="${msg['label.ssc.play.BALL_6']}${msg['label.ssc.ball.SUM_ODD']}" for="BALL_6-SUM_ODD">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_7-SUM_ODD" id="BALL_7-SUM_ODD" data-mini="true"><label title="${msg['label.ssc.play.BALL_7']}${msg['label.ssc.ball.SUM_ODD']}" for="BALL_7-SUM_ODD">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_8-SUM_ODD" id="BALL_8-SUM_ODD" data-mini="true"><label title="${msg['label.ssc.play.BALL_8']}${msg['label.ssc.ball.SUM_ODD']}" for="BALL_8-SUM_ODD">0.00</label></fieldset></td>
			  	</tr>
			  	<tr>
			  		<td class="td-bgcolor">${msg['label.ssc.ball.SUM_EVEN']}</td>
			  		...
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_6-SUM_EVEN" id="BALL_6-SUM_EVEN" data-mini="true"><label title="${msg['label.ssc.play.BALL_6']}${msg['label.ssc.ball.SUM_EVEN']}" for="BALL_6-SUM_EVEN">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_7-SUM_EVEN" id="BALL_7-SUM_EVEN" data-mini="true"><label title="${msg['label.ssc.play.BALL_7']}${msg['label.ssc.ball.SUM_EVEN']}" for="BALL_7-SUM_EVEN">0.00</label></fieldset></td>
			  		<td><fieldset data-role="controlgroup" data-type="horizontal"><input type="checkbox" name="BALL_8-SUM_EVEN" id="BALL_8-SUM_EVEN" data-mini="true"><label title="${msg['label.ssc.play.BALL_8']}${msg['label.ssc.ball.SUM_EVEN']}" for="BALL_8-SUM_EVEN">0.00</label></fieldset></td>
			  	</tr>
			  </tbody>
			</table>
			</div>
