...
var bonStr = '{"SERIAL_1_1":"1","SERIAL_2_2":"2","SERIAL_3_3":"3","SERIAL_4_4":"4","SERIAL_5_5":"5","SERIAL_6_5":"6","SERIAL_7_5":"7","SERIAL_8_5":"8"}';
var bonNum = eval('(' + bonStr + ')');
</script>
</head>
<c:set var="page_title" value="${msg['title.ssc.JXSYXW']}" scope="request"/>
<body>
	<section  data-role="page" id="rateInfoPage">
		...
		<div class="ui-on-lottery">		
		    ...
		    <div class="handicap-info">
  			...
  			<div data-role="navbar">
			    <ul>
			        <li><a href="#" ${obj.nav == 1 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeBetOn('SERIAL_1_1')">一中一</a></li>
			        <li><a href="#" ${obj.nav == 2 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeBetOn('SERIAL_2_2')">二中二</a></li>
			        <li><a href="#" ${obj.nav == 3 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeBetOn('SERIAL_3_3')">三中三</a></li>
			    	<li><a href="#" ${obj.nav == 4 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeBetOn('SERIAL_4_4')">四中四</a></li>
			    </ul>
			    <ul>
			        <li><a href="#" ${obj.nav == 5 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeBetOn('SERIAL_5_5')">五中五</a></li>
			        <li><a href="#" ${obj.nav == 6 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeBetOn('SERIAL_6_5')">六中五</a></li>
			        <li><a href="#" ${obj.nav == 7 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeBetOn('SERIAL_7_5')">七中五</a></li>
			        <li><a href="#" ${obj.nav == 8 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeBetOn('SERIAL_8_5')">八中五</a></li>
			    </ul>
			</div>
		...
		<input type="hidden" id="play_text" value="一中一">
	</section>
