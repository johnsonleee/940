...
function changeBetOn(betOn,flag){
	$("#bon").val(betOn);
	if(betOn=='SANZIDW_QS'){
		$("#play_text").val(replaceAllHtml("${msg['title.ssc.SDW']} ${msg['label.ssc.play.QS']}"));
	}
	if(betOn=='SANZIDW_ZS'){
...
<body>
	<section  data-role="page" id="rateInfoPage">
		...
		<div class="ui-on-lottery">	
		    ...
		    <div class="table-cotent-lottery">
  			<div data-role="navbar">
			    <ul>
			        <li><a href="#" ${obj.nav == 1 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeBetOn('SANZIDW_QS')">${msg['label.ssc.play.QS']}</a></li>
			        <li><a href="#" ${obj.nav == 2 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeBetOn('SANZIDW_ZS')">${msg['label.ssc.play.ZS']}</a></li>
			        <li><a href="#" ${obj.nav == 3 ? "class='ui-btn-active'" : ""} data-ajax="false" onclick="changeBetOn('SANZIDW_HS')">${msg['label.ssc.play.HS']}</a></li>
			    </ul>
			</div>
		...
		<input type="hidden" id="play_text" value="${msg['title.ssc.SDW']} ${msg['label.ssc.play.QS']}">
	</section>
